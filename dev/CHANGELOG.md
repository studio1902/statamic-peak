...
### What's new
- Rework the Tailwind Typography configuration to use modifiers in a partial. #190 and 6af6fe25 by @robdekort
- Add a CP widget display assets with missing alt texts. #191 by @robdekort
