...
return [
    ...
    'widget_assets_count'               => '{0}You have :amount image that need attention.|{1}You have :amount image that needs attention.|[2,*]You have at least :amount images that need attention.',
