...
Running `php please warm` after your deployments will visit all urls and warm up the static cache. This is a custom command and is defined in `app/console/commands/WarmCommand.php`. 
